// encoding="UTF-8"
/**
 * Copié de http://elec.enc.sorbonne.fr/2diple/theme/diple.js
 * permet de fonctionner hors ligne
 */


/**
 * Naviguer d'une ancre à la suivante
 */
...
var Dia = {
  ...
  init:function (tagName, className) {
    ...
    for (var i=0;i<max;i++) {
      ...
      if (!o.id) o.id="dia"+string(i);
      if (!Dia.prem) Dia.prem=o.id;
      if(prev) {
        prev.next=o.id;
        o.prev=prev.id;
      }
